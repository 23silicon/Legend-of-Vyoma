...
{
	private final static String[] downAnimation	= {"Link walk down 1", "Link walk down 6", "Link stand down"};
	private final static String[] upAnimation	= {"Link walk up 1", "Link stand up", "Link walk up 6"};
	private final static String[] leftAnimation	= {"Link walk left 1","Link stand left", "Link walk left 6"};
	private final static String[] rightAnimation= {"Link walk right 1", "Link stand right", "Link walk right 6"};
