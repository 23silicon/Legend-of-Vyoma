...
{
	private final static String[] downAnimation	= {"Link sword down 1", "Link sword down 2", "Link sword down 4", "Link sword down 6"};
	private final static String[] upAnimation	= {"Link sword up 1", "Link sword up 3", "Link sword up 5",  "Link sword up 7", "Link sword up 8", "Link sword up 9"};
	private final static String[] leftAnimation	= {"Link sword left 1",  "Link sword left 3", "Link sword left 4", "Link sword left 6", "Link sword left 8", "Link sword left 9"};
	private final static String[] rightAnimation= { "Link sword right 2", "Link sword right 3", "Link sword right 5", "Link sword right 6", "Link sword right 8"};
