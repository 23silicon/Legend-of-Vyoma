...
{
	private final static String[] downAnimation	= {"Link bow down 3"};
	private final static String[] upAnimation	= {"Link bow up 3"};
	private final static String[] leftAnimation	= {"Link bow left 3"};
	private final static String[] rightAnimation= {"Link bow right 2"};
