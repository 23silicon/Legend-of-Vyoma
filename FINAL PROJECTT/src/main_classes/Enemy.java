...
//****CONSTRUCTION ZONE KEEP OUT****
	...
	public Enemy(String type, int px, int py, Insets insets) {
		super(px,py, insets); //sets position of enemy
		this.type = type;
		switch (type) {
			case "Octorok":
				hp = 1;
	 ...
	 */
	public Enemy(String type, int health, int attack, int pathfindingEfficiency, int px, int py, Insets insets) {
		super(px,py,insets); //sets position of enemy
		this.type = type;
		hp = health;
		atk = attack;
